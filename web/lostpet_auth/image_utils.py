...
class ImageText(object):
    def __init__(self, filename_or_size, mode='RGBA', background=(0, 0, 0, 0),
        ...
        print type(filename_or_size)
        print isinstance(filename_or_size, str)
    ...
    def write_text_box(self, (x, y), text, box_width, font_filename,
        ...
        for index, line in enumerate(lines):
            ...
            if place == 'left':
                ...
                self.draw.rectangle(((0,0),(box_width,50)), fill="red", outline = "red")
                self.write_text((x_left, 5), line, font_filename,
                                font_size, color)
            elif place == 'justify':
                words = line.split()
